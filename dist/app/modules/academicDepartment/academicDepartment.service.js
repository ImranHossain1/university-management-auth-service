...
const getSingleDepartment = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicDepartment_model_1.AcademicDepartment.findById(id).populate('academicFacultyId');
    return result;
});
...
const insertIntoDBFromEvent = (e) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const payload = {
        title: e.title,
        academicFacultyId: academicFaculty === null || academicFaculty === void 0 ? void 0 : academicFaculty._id,
        syncId: e.id,
    };
